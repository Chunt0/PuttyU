...
MAX_PERSONAL_UPLOAD_BYTES = int(
    app_env("PERSONAL_UPLOAD_MAX_BYTES", str(25 * 1024 * 1024))
)
...
def setup_personal_routes(personal_docs_manager, rag_manager, rag_available):
    ...
    @router.post("/upload", response_model=PersonalUploadResponse)
    ...
    @router.delete("/file", response_model=PersonalDeleteResponse)
