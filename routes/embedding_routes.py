...
from src.request_models import EmbeddingModel, EmbeddingEndpointResponse
...
def setup_embedding_routes():
    ...
    @router.get("/models", response_model=List[EmbeddingModel])
    def list_models():
    ...
    @router.get("/endpoint", response_model=EmbeddingEndpointResponse)
    def get_endpoint():
