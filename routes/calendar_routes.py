...
# Override at deploy time via `PUTTYU_FALLBACK_OWNER` env var. In a real
# multi-user install set `PUTTYU_SINGLE_USER=0` so unauthenticated requests
# are rejected instead of silently writing to this address.
FALLBACK_OWNER = app_env("FALLBACK_OWNER", "owner@localhost")
_SINGLE_USER_MODE = app_env("SINGLE_USER", "1") != "0"
