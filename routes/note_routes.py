...
from src.request_models import NoteResponse, NoteListResponse, OkResponse
...
def setup_note_routes(task_scheduler=None):
    ...
    # --- TOGGLE PIN ---
    @router.post("/{note_id}/pin", response_model=OkResponse)
    ...
    # --- TOGGLE ARCHIVE ---
    @router.post("/{note_id}/archive", response_model=OkResponse)
