"""scripts/_lib/cli.py — shared scaffolding for the `puttyu-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("puttyu-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/puttyu-foo`
...
VERSION = "0.1.0"  # bumped centrally; every puttyu-* CLI reports this
