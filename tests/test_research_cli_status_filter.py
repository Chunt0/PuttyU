"""`puttyu-research list --status complete` was returning nothing.
...
Part of #2122 (puttyu-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "puttyu-research"
    loader = importlib.machinery.SourceFileLoader("puttyu_research_cli", str(path))
