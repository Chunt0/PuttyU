...
| Vitest | `cd web && bun run test` | **222 passed** (+ T5 dashboard/miner/dial/summary/cmdk/cost) |
| Playwright | `cd web && bun run e2e` | **36 passed, 2 skipped** (+ T5 dashboard/miner/summary/cmdk/cost) |
