...
COPILOT_USER_AGENT = os.environ.get(
    "PUTTYU_COPILOT_USER_AGENT", "puttyU/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "PUTTYU_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "PUTTYU_COPILOT_EDITOR_VERSION", "puttyU/1.0"
)
