...
- [ ] I searched [open issues](https://github.com/Chunt0/PuttyU/issues) and [open PRs](https://github.com/Chunt0/PuttyU/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses puttyU's existing visual language. Specifically:
