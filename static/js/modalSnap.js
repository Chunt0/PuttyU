...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'puttyu-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'puttyu-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('puttyu:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
