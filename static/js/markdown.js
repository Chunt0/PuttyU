...
function initMermaid() {
  if (!window.mermaid || window.__puttyuMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__puttyuMermaidReady = true;
}
window.puttyuInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'puttyu-thinking-expanded';
