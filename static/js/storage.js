...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'puttyu-model-expanded',
  MODEL_ENDPOINTS: 'puttyu-model-endpoints',
  MODEL_SELECTED: 'puttyu-selected-model',
  SORT_ORDER: 'puttyu-sessions-sort',
  CHAT_SEARCH_SCOPE: 'puttyu-search-scope',
  INCOGNITO: 'puttyu-incognito',
  RAG_ACTIVE: 'puttyu-rag-active',
  MCP_ACTIVE: 'puttyu-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'puttyu-density',
  WORKSPACE: 'puttyu-workspace',
  PLAN: 'puttyu-plan'
};
